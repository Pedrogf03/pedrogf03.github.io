const translations = {
  ...
  "es": {
    ...
    "about_p1": "Soy un desarrollador de software con una base sólida en Java, Spring Boot y bases de datos SQL, complementada con experiencia en Flutter y desarrollo multiplataforma. Me enfoco en construir aplicaciones escalables y mantenibles con arquitectura limpia y código de alta calidad.",
    "about_p2": "He ganado experiencia práctica en Sipos, KnowmadMood y Trace, trabajando en proyectos reales que involucran mantenimiento y desarrollo backend, resolución de incidencias, pruebas automatizadas y optimización del rendimiento.",
    "about_p3": "Actualmente, estoy cursando una especialización en <strong>Inteligencia Artificial y Big Data</strong>, después de completar una en Ciberseguridad, lo que mejora mi comprensión holística del desarrollo de software seguro y orientado a datos.",
    "about_p4": "Estoy orientado a resultados, soy analítico y me apasiona la mejora continua. Busco una oportunidad para crecer como desarrollador backend o full-stack, aportando soluciones técnicas sólidas y una mentalidad proactiva.",
    "about_p5": "🏆 Logros notables incluyen el 10º puesto nacional en ProgramaMe 2024 y el 2º puesto en la fase regional de SpainSkills 2023.",
    ...
    "project_hangman_desc": "Versión multijugador del clásico juego del Ahorcado. Utiliza una arquitectura cliente-servidor con Sockets de Java para permitir jugar en red.",
    ...
    "test1_quote": "\"Pedro ha demostrado una gran capacidad de adaptación y una sólida base técnica en Java y Spring, resolviendo incidencias de forma eficaz y proactiva.\"",
    "test1_cite": "— Tutor de Prácticas, Knowmad Mood",
    "test1_button": "Ver carta completa (PDF)",
    "test2_quote": "\"Sus conocimientos en aplicaciones web o multiplataforma han sido realmente útiles... Dispuesto siempre a ayudar, se le puede definir como una persona generosa y con un amplio conocimiento en el mundo de aplicaciones.\"",
  ...
  "en": {
    ...
    "about_p1": "I’m a software developer with a strong foundation in Java, Spring Boot, and SQL databases, complemented by experience in Flutter and cross-platform development. I focus on building scalable, maintainable applications with clean architecture and high-quality code.",
    "about_p2": "I’ve gained hands-on experience at Sipos, KnowmadMood, and Trace, working on real-world projects involving backend maintenance and development, issue resolution, automated testing, and performance optimization.",
    "about_p3": "Currently, I’m pursuing a specialization in <strong>Artificial Intelligence and Big Data</strong>, after completing one in Cybersecurity, which enhances my holistic understanding of secure and data-driven software development.",
    "about_p4": "I’m results-oriented, analytical, and passionate about continuous improvement. I’m seeking an opportunity to grow as a backend or full-stack developer, contributing solid technical solutions and a proactive mindset.",
    "about_p5": "🏆 Notable achievements include ranking 10th nationally at ProgramaMe 2024 and 2nd place at the SpainSkills 2023 regional stage.",
    ...
    "project_hangman_desc": "Multiplayer version of the classic Hangman game. It uses a client-server architecture with Java Sockets to allow network play.",
    "project_hangman_stack": "<strong>Stack:</strong> Java, Java Sockets, Multithreading",
    "project_ordeplay_title": "OrdePlay",
    "project_ordeplay_desc": "Web Application for purchasing video games online. Also allows users to create personalized game lists.",
    "project_ordeplay_stack": "<strong>Stack:</strong> PHP, HTML, CSS, JavaScript, jQuery, Ajax, MySQL",
    ...
    "test1_quote": "\"Pedro has shown a great capacity for adaptation and a solid technical foundation in Java and Spring, resolving incidents effectively and proactively.\"",
    "test1_cite": "— Internship Tutor, Knowmad Mood",
    "test1_button": "View full letter (PDF)",
    "test2_quote": "\"His knowledge in web or multiplatform applications has been really useful... Always willing to help, he can be defined as a generous person with extensive knowledge in the world of applications.\"",
